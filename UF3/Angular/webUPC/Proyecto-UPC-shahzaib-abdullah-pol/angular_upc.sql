...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2024 a las 20:09:52
...
(5, '2024_03_09_171853_create_events_table', 1),
(6, '2024_03_10_153346_create_tournaments_table', 1);
...
CREATE TABLE `users` (
  ...
  `type` enum('autonomo','empresa') NOT NULL,
